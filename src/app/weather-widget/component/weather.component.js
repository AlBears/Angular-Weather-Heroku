...
var WeatherComponent = (function () {
    ...
    WeatherComponent.prototype.setStyles = function () {
        if (this.weatherData.icon) {
            this.icons.color = colors_1.WEATHER_COLORS[this.weatherData.icon]['color'];
            return colors_1.WEATHER_COLORS[this.weatherData.icon];
        }
        else {
            this.icons.color = colors_1.WEATHER_COLORS['default']['color'];
            return colors_1.WEATHER_COLORS["default"];
        }
    };
